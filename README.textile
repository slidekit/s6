...
h2. Powered by S6 - What's Slide Show (S9)?
...
with S6 templates built-in. More "Slide Show ==(S9)== Project Site":http://slideshow.rubyforge.org &raquo;

h2. S6 in Action - Sample Slide Shows Online

Try some slide show samples:
